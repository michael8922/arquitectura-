...
namespace CapaGUI
{
    public partial class PantallaIngresoProducto : Form
    {
        public PantallaIngresoProducto()
        {
            InitializeComponent();
        }
        ...
        private void PantallaIngresoProducto_Load(object sender, EventArgs e)
        {
            
            // TODO: esta línea de código carga datos en la tabla 'controlExistenciasDataSet6.proveedor' Puede moverla o quitarla según sea necesario.
            this.proveedorTableAdapter1.Fill(this.controlExistenciasDataSet6.proveedor);
            // TODO: esta línea de código carga datos en la tabla 'controlExistenciasDataSet5.usuario' Puede moverla o quitarla según sea necesario.
            this.usuarioTableAdapter1.Fill(this.controlExistenciasDataSet5.usuario);
            // TODO: esta línea de código carga datos en la tabla 'controlExistenciasDataSet4.producto' Puede moverla o quitarla según sea necesario.
            this.productoTableAdapter.Fill(this.controlExistenciasDataSet4.producto);
            // TODO: esta línea de código carga datos en la tabla 'controlExistenciasDataSet3.sucursal' Puede moverla o quitarla según sea necesario.
            this.proveedorTableAdapter.Fill(this.controlExistenciasDataSet2.proveedor);
        ...
        public void cargarComboBoxIngreso()
        {
            ...
            Usuario auxUsuario = auxUsuarioNegocio.buscarUsuario(this.labelIdUsuario.Text);
            NegocioProveedor auxNegocioProveedor = new NegocioProveedor();
            Proveedor auxProveedor = auxNegocioProveedor.buscarProveedor(this.labelIdProveedor.Text);
        ...
        public void mostrarIngreso()
        {
            ...
            this.ultimo = auxNegocioIngreso.listarIngresoProducto().Tables["ingreso_p"].Rows.Count - 1;
            if (this.posicion <= 0)
                this.posicion = 0;
            if (this.posicion >= ultimo)
                this.posicion = ultimo;

            auxIngreso = auxNegocioIngreso.retornaPosicionIngresoProducto(this.posicion);
        ...
        public void mostrarDetalle()
        {
            ...
            this.Ultimo2 = auxNegocioDetalle.retornarDetalleIngresoProducto(this.txtIdIngreso.Text).Tables["det_ingreso"].Rows.Count - 1;
            if (this.Posicion2 <= 0)
                this.Posicion2 = 0;
            if (this.Posicion2 >= Ultimo2)
                this.Posicion2 = Ultimo2;

            auxDetalle = auxNegocioDetalle.retornaPosicionDetalleIngresoProducto(this.Posicion2,this.txtIdIngreso.Text);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    Ingreso_P auxIngresoProducto = new Ingreso_P();
                    ...
                    if (String.IsNullOrEmpty(auxNegocioIngreso.buscarIngresoProducto(auxIngresoProducto.Id_ingreso).Id_ingreso))
                    {
                        ...
                        {
                            auxNegocioIngreso.insertarIngresoProducto(auxIngresoProducto);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    auxNegocioIngreso.actualizarIngresoProducto(auxIngreso);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.btnEliminar.Text == "eliminar")
                {
                    ...
                    {
                        if (String.IsNullOrEmpty(auxNegocioDetalle.buscarDetallePorIdIngreso(auxDetalle.Ingreso_p_id_ingreso).Ingreso_p_id_ingreso)
                            && auxNegocioIngreso.buscarIngresoProducto(auxIngreso.Id_ingreso).Id_ingreso == this.txtIdIngreso.Text)
                        {
                            auxNegocioIngreso.eliminarIngresoProducto(auxIngreso.Id_ingreso);
        ...
        private void btnGuardarDetalle_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                try
                {
                    ...
                    if (String.IsNullOrEmpty(auxNegocioDetalle.buscarDetalleIngresoProducto(auxDetalle.Id_detalle_ingreso).Id_detalle_ingreso))
                    {
                        ...
                        else
                        {
                            if (auxDetalle.Cantidad > 0)
                            {
                                ...
                                {
                                    auxNegocioDetalle.insertarDetalleIngresoProducto(auxDetalle);
            ...
            if (this.btnEliminarDetalle.Text == "eliminar")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        auxNegocioDetalle.eliminarDetalleIngresoProducto(auxDetalle.Id_detalle_ingreso);
