...
namespace CapaGUI
{
    public partial class PantallaMenu : Form
    {
        ...
        {
            openChildForm(new PantallaMantenedorUsuario());
            this.activarSubMenu();
        ...
        {
            openChildForm(new PantallaMantenedorProducto());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaListadoProducto());
            this.activarSubMenu();
        }
        ...
        private void btnUbicacion_Click_1(object sender, EventArgs e)
        {
            this.mostrarSubMenu(this.panelSubMenuUbicacion);
        }
        ...
        {
            openChildForm(new PantallaMantenedorProveedor());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaIngresoProducto());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaSalidaProducto());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaListadoSalidaProducto());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaMantenedorMerma());
            this.activarSubMenu();
        }

        //-----------------------------------------------------------------------------------------------------------------------------------------

        private void btnAgregarUbicacion_Click_1(object sender, EventArgs e)
        {
            openChildForm(new PantallaMantenedorUbicacion());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaConsultaSaldo());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaListadoIngresoProducto());
            this.activarSubMenu();
        }
        ...
        {
            openChildForm(new PantallaListadoMerma());
            this.activarSubMenu();
        }
