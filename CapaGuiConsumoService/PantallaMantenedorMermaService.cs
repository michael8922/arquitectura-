...
{
    public partial class PantallaMantenedorMermaService : Form
    {
        public PantallaMantenedorMermaService()
        {
            InitializeComponent();
        }

        private void PantallaMantenedorMermaService_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'controlExistenciasDataSet7.producto' Puede moverla o quitarla según sea necesario.
            this.productoTableAdapter.Fill(this.controlExistenciasDataSet7.producto);
            // TODO: esta línea de código carga datos en la tabla 'controlExistenciasDataSet6.usuario' Puede moverla o quitarla según sea necesario.
            this.usuarioTableAdapter.Fill(this.controlExistenciasDataSet6.usuario);
        ...
        public void mostrarMerma()
        {
            ...
            ServiceMantenedorMerma.Merma auxMerma = new ServiceMantenedorMerma.Merma();
            


            this.ultimo = auxNegocioMerma.retornarMermaService().Tables["merma"].Rows.Count - 1;
            if (this.posicion <= 0)
                this.posicion = 0;
            if (this.posicion >= ultimo)
                this.posicion = ultimo;

            auxMerma = auxNegocioMerma.retornaPosicionMermaService(this.posicion);
        ...
        {
            ServiceMantenedorDetalleMerma.WebServiceMantenedorDetMermaSoapClient auxNegocioDetalle = new ServiceMantenedorDetalleMerma.WebServiceMantenedorDetMermaSoapClient();
            ServiceMantenedorDetalleMerma.Det_Merma auxDetalle = new ServiceMantenedorDetalleMerma.Det_Merma();
            


            this.Ultimo2 = auxNegocioDetalle.retornarDetalleMermaService(this.txtIdMerma.Text).Tables["det_merma"].Rows.Count - 1;
            if (this.Posicion2 <= 0)
                this.Posicion2 = 0;
            if (this.Posicion2 >= Ultimo2)
                this.Posicion2 = Ultimo2;

            auxDetalle = auxNegocioDetalle.retornaPosicionDetalleMermaService(this.Posicion2, this.txtIdMerma.Text);
        ...
        private void btnAgregarMerma_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (String.IsNullOrEmpty(auxNegocioMerma.buscarMermaService(auxMerma.Id_merma).Id_merma))
                    {
                        ...
                        {
                            auxNegocioMerma.insertarMermaService(auxMerma); ;
        ...
        private void btnModificarMerma_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    auxMerma.Motivo = this.txtMotivo.Text;
                    auxMerma.Usuario_rut = this.comboBoxRutUsuario.SelectedValue.ToString();
                    auxNegocioMerma.actualizarMermaService(auxMerma);
        ...
        private void btnEliminarMerma_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.btnEliminarMerma.Text == "eliminar")
                {
                    ...
                    {
                        if (String.IsNullOrEmpty(auxNegocioDetalle.buscarDetallePorIdMermaService(auxDetalle.Merma_id_merma).Merma_id_merma)
                            && auxNegocioMerma.buscarMermaService(auxMerma.Id_merma).Id_merma == this.txtIdMerma.Text)
                        {
                            auxNegocioMerma.eliminarMermaService(auxMerma.Id_merma);
        ...
        private void btnEliminarDetalle_Click(object sender, EventArgs e)
        {
            ...
            if (this.btnEliminarDetalle.Text == "eliminar")
            {
                ...
                {
                    if (String.IsNullOrEmpty(auxNegocioDetalle.buscarDetalleMermaService(auxDetalle.Id_det_merma).Id_det_merma))
                    {
                    ...
                    else
                    {
                        ...
                        auxNegocioDetalle.eliminarDetalleMermaService(auxDetalle.Id_det_merma);
                    ...
                    if (String.IsNullOrEmpty(auxNegocioDetalle.buscarDetalleMermaService(auxDetalle.Id_det_merma).Id_det_merma))
                    {
                        ...
                        else
                        {
                            if (auxDetalle.Cantidad > 0)
                            {
                                ...
                                {
                                    auxNegocioDetalle.insertarDetalleMermaService(auxDetalle);
                                    auxProducto.Codigo = this.comboBoxCodigoProducto.Text;
