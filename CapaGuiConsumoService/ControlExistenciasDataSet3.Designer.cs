...
namespace CapaGuiConsumoService {
    ...
    public partial class ControlExistenciasDataSet3 : global::System.Data.DataSet {
        ...
        public partial class usuarioDataTable : global::System.Data.TypedTableBase<usuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuarioRow AddusuarioRow(string rut, string nombre) {
...
namespace CapaGuiConsumoService.ControlExistenciasDataSet3TableAdapters {
    ...
    public partial class usuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[usuario] WHERE (([rut] = @Original_rut) AND ((@IsNull_nombre =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuario] ([rut], [nombre]) VALUES (@rut, @nombre);\r\nSELECT rut" +
                ", nombre FROM usuario WHERE (rut = @rut)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[usuario] SET [rut] = @rut, [nombre] = @nombre WHERE (([rut] = @Orig" +
                "inal_rut) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Origina" +
                "l_nombre)));\r\nSELECT rut, nombre FROM usuario WHERE (rut = @rut)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT rut, nombre FROM dbo.usuario";
        ...
        public virtual int Fill(ControlExistenciasDataSet3.usuarioDataTable dataTable) {
        ...
        public virtual ControlExistenciasDataSet3.usuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ControlExistenciasDataSet3.usuarioDataTable dataTable = new ControlExistenciasDataSet3.usuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ControlExistenciasDataSet3.usuarioDataTable dataTable) {
        ...
        public virtual int Delete(string Original_rut, string Original_nombre) {
        ...
        public virtual int Insert(string rut, string nombre) {
            if ((rut == null)) {
        ...
        public virtual int Update(string rut, string nombre, string Original_rut, string Original_nombre) {
            if ((rut == null)) {
                throw new global::System.ArgumentNullException("rut");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string Original_rut, string Original_nombre) {
            return this.Update(Original_rut, nombre, Original_rut, Original_nombre);
        }
    }
